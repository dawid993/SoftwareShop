...
describe("c-question-answers", () => {
    ...
    it("should instantiate multiselect answer component and get 2 selected answers", () => {
        ...
        return Promise.resolve().then(() => {
            const multiselectAnswerCmp = element.shadowRoot.querySelector("c-question-multi-select-answer");
            multiselectAnswerCmp.shadowRoot.querySelector("input[data-id='2']").click();
            multiselectAnswerCmp.shadowRoot.querySelector("input[data-id='3']").click();
            expect(element.getSelectedAnswers().length).toBe(2);
            expect(element.getSelectedAnswers().filter(elem => +elem === 2).length).toBe(1);
            expect(element.getSelectedAnswers().filter(elem => +elem === 3).length).toBe(1);
        })
    });
    ...
    it("should instantiate single select answer component and get 1 selected answers", () => {
        ...
        document.body.appendChild(element);
        return Promise.resolve().then(() => {
            const singleselectAnswerCmp = element.shadowRoot.querySelector("c-question-single-select-answer");
            singleselectAnswerCmp.shadowRoot.querySelector("input[data-id='2']").click();
    ...
    it("should instantiate single select answer component select one answer and then select another", () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(element.getSelectedAnswers().length).toBe(1);
            expect(+element.getSelectedAnswers()[0]).toBe(2);
            singleselectAnswerCmp.shadowRoot.querySelector("input[data-id='1']").click();
    ...
    it("should preselect answers for multiselect answers component", () => {
        ...
        return Promise.resolve().then(() => {
            ...
            const multiselectAnswerCmp = element.shadowRoot.querySelector("c-question-multi-select-answer");
            const results = Array.from(multiselectAnswerCmp.shadowRoot.querySelectorAll('input[data-id]'))
    ...
    it("should preselect answers for single select answers component", () => {
        ...
        return Promise.resolve().then(() => {
            ...
            const singleSelectAnswerCmp = element.shadowRoot.querySelector("c-question-single-select-answer");
            const results = Array.from(singleSelectAnswerCmp.shadowRoot.querySelectorAll('input[data-id]'))
                .filter(input => input.checked)
                .map(input => input.dataset.id)
                .sort();
    ...
    it("should preselect answers for slider answers component", () => {
        ...
        return Promise.resolve().then(() => {
            ...
            const singleSelectAnswerCmp = element.shadowRoot.querySelector("c-question-slider-answer");
            const results = singleSelectAnswerCmp.shadowRoot.querySelector('lightning-slider').value;
