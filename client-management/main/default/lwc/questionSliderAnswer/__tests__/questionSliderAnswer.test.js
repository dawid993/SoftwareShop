...
describe('c-question-slider-answer', () => {
    ...
    it('should setup slider properly', () => {
        ...
        return Promise.resolve().then(() => {
            expect(element.shadowRoot.querySelector('lightning-slider').max).toBe(questionCompoundTest[2].answers[0].max);
            expect(element.shadowRoot.querySelector('lightning-slider').value).toBe(0);
            expect(element.shadowRoot.querySelector('lightning-slider').min).toBe(questionCompoundTest[2].answers[0].min);
        });
    });
    ...
    it('should set default values when answers are improper', () => {
        ...
        document.body.appendChild(element);
        return Promise.resolve().then(() => {
            expect(element.shadowRoot.querySelector('lightning-slider').max).toBe(100);
            expect(element.shadowRoot.querySelector('lightning-slider').value).toBe(0);
            expect(element.shadowRoot.querySelector('lightning-slider').min).toBe(0);
        });
    });
    ...
    it('should set slider value and return correct answer', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(element.shadowRoot.querySelector('lightning-slider').label).toMatch(/300/);
        });
    });
});